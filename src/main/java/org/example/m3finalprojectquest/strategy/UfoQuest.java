...
public class UfoQuest extends BaseQuest{
    ...
    public void initializeQuest() {
        DialogOption dialogOption1_1 = new DialogOption("Tak", 2);
        DialogOption dialogOption1_2 = new DialogOption("Hi", -1);
        ...
        DialogOption dialogOption2_1 = new DialogOption("Tak", 3);
        DialogOption dialogOption2_2 = new DialogOption("Hi", -1);
        ...
        DialogOption dialogOption3_1 = new DialogOption("Tak", -1);
        DialogOption dialogOption3_2 = new DialogOption("Hi", -1);
